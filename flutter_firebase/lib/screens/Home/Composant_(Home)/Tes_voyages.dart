...
class Tes_Voyages extends StatefulWidget {
  const Tes_Voyages({Key? key}) : super(key: key);

  @override
  State<Tes_Voyages> createState() => _Tes_VoyagesState();
}

class _Tes_VoyagesState extends State<Tes_Voyages> {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //Espace entre le texte et la première box de voyage
          SizedBox(
            height: 10,
          ),
          Container(

...
class PageRechercheEcam extends StatefulWidget {
  const PageRechercheEcam({Key? key}) : super(key: key);

  @override
  State<PageRechercheEcam> createState() => _PageRechercheEcamState();
}

class _PageRechercheEcamState extends State<PageRechercheEcam> {
  @override
